...
public class StreamExamples {
	...
	public static void main(String[] args) {
		...
		List<Double> listRandom = MathUtils.randomNums(10).limit(10).collect(Collectors.toList());
		Double[] arrayRandom = MathUtils.randomNums(10).limit(20).toArray(Double[]::new);
	}
