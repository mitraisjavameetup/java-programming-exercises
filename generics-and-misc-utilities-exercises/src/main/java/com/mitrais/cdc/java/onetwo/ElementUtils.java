...
/**
 * Two generically typed static methods: one to return the last element of a
 * List, and another to return the last element of an array.
 */
public class ElementUtils {
	...
	public static <T> T lastElement(List<T> elements) {
		// TODO: Trainee should modify this method to return last element of
		// List
