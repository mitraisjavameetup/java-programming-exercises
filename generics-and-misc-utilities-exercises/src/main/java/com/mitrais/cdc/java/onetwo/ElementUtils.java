...
public class ElementUtils {
  ...
  /**
   * Return last element of the any type list
   * @param elements
   * @return last elements of any type list
   */
  ...
  /**
   * Return last element of the any type array
   * @param elements
   * @return last elements of any type array
   */
