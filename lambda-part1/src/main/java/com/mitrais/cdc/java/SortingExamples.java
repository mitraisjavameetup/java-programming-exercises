...
public class SortingExamples {
	...
	public static String[] sortedByLengthAscending() {
		...
		/*
		 * TO DO Sort words by length (i.e., shortest to longest)
		 * 
		 */
	...
	public static String[] sortedByLengthDescending() {
		...
		/*
		 * TO DO Sort words by reverse length (i.e., longest to shortest)
		 * 
		 */
	...
	public static String[] sortedByFirstLetter() {
		...
		/*
		 * TO DO Sort words alphabetically by the first character only
		 * 
		 */
	...
	public static String[] sortedByContains() {
		...
		// Arrays.sort(sortedByContains, (s1,s2) -> StringUtils.eChecker(s1,
		// s2));
		/*
		 * TO DO Sort words by whether it contains 'e' Strings that contain “e”
		 * first, everything else second Hint: use method StringUtils.eChecker
		 * 
		 */
