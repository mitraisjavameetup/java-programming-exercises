...
public class MathUtils {
	...
	public static List<Integer> findPrimesSerial(boolean[] primeFlags) {
		...
		TimingUtils.timeOp(new Op() {
			...
			public String runOp() {
				...
				list = collectPrimes(primeFlags);
				return "findPrimeSerialArrayParam";
			}
		});
	...
	public static List<Integer> findPrimesSerial(int size) {
		...
		TimingUtils.timeOp(new Op() {
			...
			public String runOp() {
				// TODO Auto-generated method stub
				list = findPrimesSerial(new boolean[size]);
				return "findPrimesSerialSizeParam";
			}
		});
		return list;
	}
	...
	public static List<Integer> findPrimesParallel(boolean[] primeFlags) {
		...
		TimingUtils.timeOp(new Op() {
			...
			public String runOp() {
				...
				list = collectPrimes(primeFlags);
				return "findPrimesParallelArrayParam";
			}
		});
	...
	public static List<Integer> findPrimesParallel(int size) {
		...
		TimingUtils.timeOp(new Op() {
			...
			public String runOp() {
				// TODO Auto-generated method stub
				list = findPrimesParallel(new boolean[size]);
				return "findPrimesParallelSizeParam";
			}
		});
		return list;
	}
