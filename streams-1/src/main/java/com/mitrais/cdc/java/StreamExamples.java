...
public class StreamExamples {
  ...
  public static List<String> excitingWordsStreams(){
	   ...
	   * 
	   */  
	  return words.stream().map(word -> word + "!").collect(Collectors.toList());
  }
  ...
  public static List<String> eyeWordsStreams(){
	   ...
	   * 
	   */  
	  return words.stream().map(word -> word.replace("i", "eye")).collect(Collectors.toList());	    
  }
  ...
  public static List<String> shortWordsStreams(){
	   ...
	   * 
	   */  
	  return words.stream().filter(word -> word.length() < 4).collect(Collectors.toList());
  ...
  public static List<String> wordsWithBStreams(){
	   ...
	   * 
	   */  
	  return words.stream().filter(word -> word.contains("b")).collect(Collectors.toList());
  }
  ...
  public static List<String> evenLengthWords(){
	   ...
	   * 
	   */  
	  return words.stream().filter(word -> word.length() %2 == 0).collect(Collectors.toList());
  }
  ...
  public static String firstFunnyString(String containedTest) {
	  ...
	  return words.stream().map(word -> word.toUpperCase())
			  ...
			  .filter(word -> word.contains(containedTest))
