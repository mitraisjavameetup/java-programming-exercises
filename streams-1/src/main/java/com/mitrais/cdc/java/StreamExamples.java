...
public class StreamExamples {
  ...
  public static List<String> excitingWordsStreams(){
	   ...
	   * 
	   */  
	  return words.stream().map(e -> e+"!").collect(Collectors.toList());
  }
  ...
  public static List<String> eyeWordsStreams(){
	   ...
	   * 
	   */  
	  return words.stream().map(e -> e.replace("i", "eye")).collect(Collectors.toList());	    
  }
  ...
  public static String[] wordsAsArray() {
	  ...
	  */
	  ...
	  String [] wordArr = words.stream().toArray(String[]::new);
	  return wordArr;
  }
