...
public class FileIOExamples {
	...
	public static String print10LetterWord(String filename) {
		...
		return StreamProcessor.processFile(filename, f -> print10LetterWord(f));
	}
	...
	public static String printNLetterWord(Stream<String> words, int wordLength) {
		...
		return words
				...
				.findFirst()
				.orElse(String.format("No %d-letter word found", wordLength));
	}
	...
	public static String printNLetterWord(String filename, int wordLength) {
		 ...
		 */
		return StreamProcessor.processFile(filename, f -> printNLetterWord(f, wordLength));
	}
	...
	public static long numWordsContaining(String filename, String subString) {
		 ...
		 * 
		 */
		return StreamAnalyzer.analyzeFile(filename, f -> numWordsContaining(f, subString));
	}	
