...
public class CarSale implements Sellable {
	...
	public double getCost() {
		 ...
		 */
		finalCost = getListPrice() - (getListPrice() * getDiscount() / 100.0);
	...
	public String toString() {
		...
		// TODO: modify this method to return sentence e.g. "This car name is
		// blablabla, its price is blabla, with discount blabla"
		toString = "This car is a " + getCarName() + ", with a price of " + getListPrice() + ", and a discount of "
				+ getDiscount();
